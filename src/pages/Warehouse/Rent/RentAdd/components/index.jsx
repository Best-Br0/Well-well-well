...
const RentAdd = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Добавление материала в аренду:', { ...formData, image: imagePreview });
  };

  return (
    <div className="rent-add-container">
      <BackList />
        ...
        <div className="form-main-layout">
          ...
          <div className="inputs-column">
            ...
            <div className="form-row">
              ...
              {/* Пустой флекс-элемент справа для выравнивания сетки по макету */}
