...
export default function ClientsManagmentPagination() {
    return (
        <div className="clientsmanagmentpagination">
            <div className="clientsmanagmentpagination_box">
                <hr className="clientsmanagmentpagination_hr" />
            </div>
